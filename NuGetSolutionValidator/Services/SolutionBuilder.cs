...
namespace NugetSolutionValidator.Services
{
    public class SolutionBuilder: IBuilder<Solution,BuildSolutionRequest>
    {
        ...
        private static readonly IDependencyFileResolver DefaultDependencyFileResolver = new FullFrameworkDependencyFileResolver();
        private static readonly IBuilder<Project, BuildProjectRequest> DefaultProjectBuilder = new ProjectBuilder(DefaultFileSystem, new NuGetPackageDependencyBuilder(DefaultFileSystem), DefaultDependencyFileResolver);
